...
function HrRegistration() {
  ...
  const onSubmit = async (data)=>{
    ...
    try{
      const response = await axios.post("http://127.0.0.1:8000/hr_login/hr_register/", datas)
      navigate("/login");
    }
    catch(error){
  ...
  {/* <Col sm>
    ...
    <Col sm={6}>
     ...
     <Form.Control 
     {...register('department',{required:"Experience is required"})}
     name="department"
  ...
  <Row>
    ...
    <Button as="input" type="submit" value="Resgister" />
          ...
          <div className="card radius shadowDepth1 shadow-lg">
              ...
              <div className="card__content card__padding">
              <img  className='img-fluid shadow-lg' src='https://dynamiccio.com/wp-content/uploads/2019/03/hr.jpg' />
              </div>
