...
function AppliedJobs() {
  return (
      ...
      <Container>
      <Row>
            <div className='text-center h1' style={{marginTop:'1rem'}} ><h1>Applied Jobs</h1></div>
        </Row>
        <Row>
        <Col sm={2}>
            <div class="card bg-c-blue order-card wrapper">
                <div class="card-block">
                    ...
                    <h2 class="text-right"><i class="fa fa-save f-left"></i><span style={{marginLeft:'1rem'}}>2</span></h2>
                    <p class="m-b-0" style={{color:'white'}}>Applied<span class="f-right">2</span></p>
                </div>
            </div>
            </Col>
            <Col sm={8}>
          ...
          <div className="card radius shadowDepth1 shadow-lg">
              ...
              <div class="card__action">
                  ...
                  <div className="card__author">
                      <img src="https://storage.needpix.com/rsynced_images/head-659652_1280.png" alt="user" style={{width:'30px',height:'30px'}} />
