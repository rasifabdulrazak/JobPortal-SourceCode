...
import {Container,Button,Carousel, Form,Col,Row,Figure,ListGroup,Alert,Card} from 'react-bootstrap'
    ...
    <Header />
      ...
      <blockquote class="blockquote blockquote-custom bg-white p-5 shadow rounded">
          ...
          <div className="card radius shadowDepth1 shadow-lg">
              ...
              <div className="card__content card__padding" style={{backgroundColor:'black'}}>
              <Carousel fade>
  <Carousel.Item>
    <img
