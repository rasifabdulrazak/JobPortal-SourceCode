...
urlpatterns = [
    ...
    path('users/user_payment/',views.payment,name = 'user_payment'),
    path('users/payment_success/',PaymentSuccessView.as_view(),name = 'payment_success'),
    path('users/user_resume/',UserResumeView.as_view(),name = 'user_resume'),
    path('users/user_resume/<int:pk>/',UserResumeView.as_view(),name = 'user_resume'),
    # path('users/premium_customers/',getPremiumCustomers,name = 'premium_customers'),
]
